...
type Pesanan struct {
	...
	Status           string      `gorm:"type:varchar(50);default:'menunggu_pembayaran'" json:"status"`          // 'menunggu_pembayaran', 'menunggu_validasi', 'diproses', 'dikirim', 'selesai', 'dibatalkan'
	StatusPembayaran string      `gorm:"type:varchar(50);default:'belum_dibayar'" json:"status_pembayaran"`    // 'belum_dibayar', 'lunas', 'gagal'
	...
	MetodePembayaran string      `gorm:"type:varchar(50);not null" json:"metode_pembayaran" binding:"required"` // 'midtrans', 'transfer_bank', 'qris'
	...
	Pembayaran       *Pembayaran   `gorm:"foreignKey:PesananID;constraint:OnDelete:CASCADE;" json:"pembayaran,omitempty"` // relasi ke tabel payments
